...
os.environ["CRAWLER_TARGETS"] = "https://luatsubaoho.com/phapluat/mau-don-dang-ky-bien-dong-dat-dai-co-huong-dan-cach-viet/"
...
from src.vietnamese_form_crawler import VietnameseFormCrawler, main
...
if __name__ == "__main__":
    ...
    print(f"  Output dir: crawler_output/")
    print("\nStarting test crawl...")
    print("="*60 + "\n")
